...
import { BookOpen, Calendar, BookMarked, Bell, MessageSquareWarning } from 'lucide-react';

const PortalCard = ({ icon: Icon, title, subtitle, buttonText, bgColor, iconBgColor, shadowColor, onClick, index }) => {
