  ...
  return (
    <div className="relative w-full min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 flex items-center justify-center overflow-hidden p-4">
      ...
      <style jsx>{`
        ...
        .animate-pulse-delayed { animation: pulse 3s cubic-bezier(0.4,0,0.6,1) infinite 1s; }
        .animate-pulse-delayed-2 { animation: pulse 3s cubic-bezier(0.4,0,0.6,1) infinite 2s; }
